...
(function () {
    ...
    function checkWin() {
        ...
        const bord7 = document.querySelector('#bord-7');
        const bord8 = document.querySelector('#bord-8');
        const bord2 = document.querySelector('#bord-2');
        const bord13 = document.querySelector('#bord-13');

        if (bord7.contains(piece4) && bord8.contains(piece2) && bord2.contains(piece1) && bord13.contains(piece3)) {
            if (!hasWon) {
